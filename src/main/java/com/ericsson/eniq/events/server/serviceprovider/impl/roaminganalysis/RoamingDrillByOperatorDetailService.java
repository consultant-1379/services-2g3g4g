...
/**
 * Implementation of roaming analysis drill detail service.Drill by operator name, country name and eventID.
 *
 * @author ezhelao
 * @since 01/2012
 */
@Stateless
@Local(Service.class)
public class RoamingDrillByOperatorDetailService extends GenericService{


    @Override
    public String getTemplatePath() {
        return ROAMING_ANALYSIS_DRILL_DETAIL_OPERATOR;
    }
