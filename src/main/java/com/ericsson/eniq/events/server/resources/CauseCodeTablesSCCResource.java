 ...
 * @since June 2010
 * 
 * Subcause codes (SCC) tables resource
 * 
 */
@Stateless
//@TransactionManagement(TransactionManagementType.BEAN)
@LocalBean
public class CauseCodeTablesSCCResource extends BaseResource {
    ...
    private String getGridData(final String requestId, final MultivaluedMap<String, String> requestParameters) {
        ...
        final String query = templateUtils.getQueryFromTemplate(
                getTemplate(CAUSE_CODE_TABLE_SCC, requestParameters, drillType), null);
