...
/**
 * Implementation of roaming analysis drill detail grid service. Drill by country name and event id.
 *
 * @author ezhelao
 * @since 01/2012
 */
@Stateless
@Local(Service.class)
public class RoamingDrillByCountryDetailService extends GenericService{


    @Override
    public String getTemplatePath() {
        return ROAMING_ANALYSIS_DRILL_DETAIL_COUNTRY;
    }
    ...
    public Map<String, Object> getServiceSpecificTemplateParameters(final MultivaluedMap<String, String> requestParameters,final FormattedDateTimeRange dateTimeRange,final TechPackList techPackList) {
        ...
        params.put(ROAMING_OBJECT,TYPE_ROAMING_COUNTRY);
    ...
    public Map<String, QueryParameter> getServiceSpecificQueryParameters(final MultivaluedMap<String, String> requestParameters) {
        final Map<String,QueryParameter>    param = new HashMap<String,QueryParameter>();
        return param;
    }
    @Override
