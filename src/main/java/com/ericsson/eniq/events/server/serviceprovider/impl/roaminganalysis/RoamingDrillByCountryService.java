...
/**
 * Implementation of roaming analysis drill service. Drill by country name.
 * 
 * @author ezhelao
 * @since 01/2012
 */
@Stateless
@Local(Service.class)
public class RoamingDrillByCountryService extends GenericService {

	@Override
	public String getTemplatePath() {
		return ROAMING_ANALYSIS_DRILL_COUNTRY;
	}
	...
	public Map<String, QueryParameter> getServiceSpecificQueryParameters(
		...
		dataServiceParameters.put(MCC_PARAM, QueryParameter
				.createStringParameter(String.valueOf(requestParameters
						.getFirst(MCC_PARAM))));
		dataServiceParameters.put(COUNTRY, QueryParameter
				.createStringParameter(String.valueOf(requestParameters
						.getFirst(COUNTRY))));
