...
public class RoamingDrillByOperatorDetailRawTest extends
    ...
    RoamingDrillByOperatorDetailService roamingDrillByOperatorDetailService;


    @Before
    public void setup() throws Exception {
        roamingDrillByOperatorDetailService = new RoamingDrillByOperatorDetailService();
        attachDependencies(roamingDrillByOperatorDetailService);
    ...
    public void testFiveMinuteQuery_SgehRaw() throws Exception {
        ...
        requestParameters.add(MNC_PARAM,TELENOR_MNC);
        requestParameters.add(EVENT_ID_PARAM,"1");
        requestParameters.add(MAX_ROWS, DEFAULT_MAX_ROWS);
        final List<RoamingDrillDetailResult> results = runQueryAssertJSONStringTransform(roamingDrillByOperatorDetailService, requestParameters);
    ...
    public void testMaxRows() throws Exception {
        ...
        requestParameters.add(MNC_PARAM,TELENOR_MNC);
        requestParameters.add(EVENT_ID_PARAM, "7");
        requestParameters.add(MAX_ROWS, "2");
        List<RoamingDrillDetailResult> results = runQueryAssertJSONStringTransform(roamingDrillByOperatorDetailService, requestParameters);
