...
public class KPIAnalysisByControllerGroupTest extends BaseKPIAnalysisTest {

    @Override
    public void onSetUp() throws Exception {
        super.onSetUp();
        createTemporaryTables(tempControllerAggTables);
        addConnectionToInterceptedDbConnectionManager(tempControllerAggTables);
        addControllerToControllerGroup();
    }

    @Test
    public void testGetKPIData_30Minutes() throws Exception {
        jndiProperties.setUpDataTieringJNDIProperty();
        populateTemporaryTablesWithEvents(THIRTY_MINUTES, HIERARCHY_3);
    ...
    public void testGetKPIData_3Hours() throws Exception {
        populateTemporaryTablesWithEvents(THREE_HOURS, HIERARCHY_3);
    ...
    public void testGetKPIData_OneWeek() throws Exception {
        populateTemporaryTablesWithEvents_OneWeek(HIERARCHY_3);
    ...
    private String getData(final String time) throws URISyntaxException {
        ...
        map.putSingle(TZ_OFFSET, PLUS_NINE_AND_A_HALF_HOURS);
