...
public class EventAnalysisDetailedWithPreparedTablesAPNTest extends BaseDataIntegrityTest<EventAnalysisDetailedResult> {
    ...
    public void onSetUp() throws Exception {
        ...
        setupRawTableValues(timestamp, localDateId, SAMPLE_APN, ATTACH_IN_2G_AND_3G, RAT_FOR_GSM, 0);
        ...
        setupRawTableValues(timestamp, localDateId, SAMPLE_APN, ATTACH_IN_4G, RAT_FOR_LTE, 0);
        ...
        setupRawTableValues(timestamp, localDateId, SAMPLE_APN, ATTACH_IN_4G, RAT_FOR_LTE, 1);
    ...
    private void setupRawTableValues(final String timestamp, final String localDateId, final String apn, final int eventId, final int rat,
