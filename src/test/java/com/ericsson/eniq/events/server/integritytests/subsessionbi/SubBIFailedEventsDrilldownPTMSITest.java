...
import static com.ericsson.eniq.events.server.common.ApplicationConstants.TYPE_PTMSI;
...
public class SubBIFailedEventsDrilldownPTMSITest extends
    ...
    @Test
    public void testSubBIFailedEvents_PTMSI_ATTACH() throws Exception {
        ...
        map.putSingle(PTMSI_PARAM, Long.toString(SAMPLE_PTMSI_VALUE));
