...
public class RoamingDrillByOperatorRawTest extends
    ...
    private void insertAllRawData() throws SQLException, ParseException {
        ...
        insertSgehRawDataRow(NORWAY_MCC,NORWAT_TELENOR_MNC,"1","001",dateTime,SAMPLE_TAC_NUM,"1",localDateId);
        insertSgehRawDataRow(NORWAY_MCC,NORWAT_TELENOR_MNC,"0","000",dateTime,SAMPLE_TAC_NUM,"1",localDateId);
        insertSgehRawDataRow(NORWAY_MCC, NORWAT_TELENOR_MNC, "1", "002", dateTime, SAMPLE_TAC_NUM,"1",localDateId);
        insertSgehRawDataRow(NORWAY_MCC, OTHER_MNC, "1", "003", dateTime, SAMPLE_TAC_NUM,"1",localDateId);
        insertSgehRawDataRow(NORWAY_MCC,OTHER_MNC,"1","003",dateTime,SAMPLE_TAC_NUM,"1",localDateId);


        insertSgehRawDataRow(NORWAY_MCC,NORWAT_TELENOR_MNC,"1","001",dateTime,SAMPLE_TAC_NUM,"2",localDateId);
        insertSgehRawDataRow(NORWAY_MCC,OTHER_MNC,"0","001",dateTime,SAMPLE_TAC_NUM,"2",localDateId);
        insertSgehRawDataRow(NORWAY_MCC, OTHER_MNC, "1", "002", dateTime, SAMPLE_TAC_NUM,"2",localDateId);
        insertSgehRawDataRow(NORWAY_MCC, NORWAT_TELENOR_MNC, "0", "003", dateTime, SAMPLE_TAC_NUM,"2",localDateId);
        insertSgehRawDataRow(NORWAY_MCC,OTHER_MNC,"1","004",dateTime,SAMPLE_TAC_NUM,"2",localDateId);



        insertSgehRawDataRow(NORWAY_MCC, NORWAT_TELENOR_MNC, "1", "003", dateTime, SAMPLE_TAC_NUM,"2",localDateId);
        insertSgehRawDataRow(NORWAY_MCC, NORWAT_TELENOR_MNC, "1", "003", dateTime, SAMPLE_TAC_NUM,"2",localDateId);
        insertSgehRawDataRow(NORWAY_MCC,OTHER_MNC,"1","003",dateTime,SAMPLE_TAC_NUM,"2",localDateId);

        insertLteRawDataRow(NORWAY_MCC,NORWAT_TELENOR_MNC,"1","001",dateTime,SAMPLE_TAC_NUM,"7",localDateId);
        insertLteRawDataRow(NORWAY_MCC,OTHER_MNC,"0","001",dateTime,SAMPLE_TAC_NUM,"7",localDateId);
        insertLteRawDataRow(NORWAY_MCC, OTHER_MNC, "1", "002", dateTime, SAMPLE_TAC_NUM,"7",localDateId);
        insertLteRawDataRow(NORWAY_MCC, NORWAT_TELENOR_MNC, "0", "003", dateTime, SAMPLE_TAC_NUM,"7",localDateId);
        insertLteRawDataRow(NORWAY_MCC,OTHER_MNC,"1","004",dateTime,SAMPLE_TAC_NUM,"7",localDateId);
