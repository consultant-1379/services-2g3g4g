 ...
 * 
 */
public class SubBIDetailsWeekTest extends TestsWithTemporaryTablesBaseTestCase<SubBIDetailsResult> {
    ...
    private static final int TEST_TZ_OFFSET_IN_SECONDS = 3600;
    ...
    private void populateRawTables() throws SQLException {
        SGEH_LAST_SEEN_RAW = DateTimeUtilities.getDateTime(Calendar.MINUTE, -4300);
        SGEH_FIRST_SEEN_RAW = DateTimeUtilities.getDateTime(Calendar.MINUTE, -4400);

        rawTableValues.put("DATETIME_ID", DateTimeUtilities.getDateTimeMinusDay(3));
        rawTableValues.put("EVENT_TIME", DateTimeUtilities.getDateTimeMinusDay(3));
        ...
        LTE_LAST_SEEN_RAW = DateTimeUtilities.getDateTime(Calendar.MINUTE, -4300);
        LTE_FIRST_SEEN_RAW = DateTimeUtilities.getDateTime(Calendar.MINUTE, -4400);
    ...
    private void populateIMSISucRawTables() throws SQLException {
        SGEH_LAST_SEEN_IMSI_RAW = DateTimeUtilities.getDateTime(Calendar.MINUTE, -4300);
        SGEH_FIRST_SEEN_IMSI_RAW = DateTimeUtilities.getDateTime(Calendar.MINUTE, -4400);

        sgehIimsiTableValues.put("DATETIME_ID", DateTimeUtilities.getDateTimeMinusDay(3));
        ...
        lteImsiTableValues.put("DATETIME_ID", DateTimeUtilities.getDateTimeMinusDay(3));
        ...
        LTE_LAST_SEEN_IMSI_RAW = DateTimeUtilities.getDateTime(Calendar.MINUTE, -4300);
        LTE_FIRST_SEEN_IMSI_RAW = DateTimeUtilities.getDateTime(Calendar.MINUTE, -4400);
    ...
    private void validateResultsSGEH_SucRawEnabled(final SubBIDetailsResult result) throws ParseException {
        ...
        expected.setFirstObserved(DateTimeUtilities.applyOffsetToDateTimeInSeconds(SGEH_FIRST_SEEN_RAW, TEST_TZ_OFFSET_IN_SECONDS) + ".0");
        expected.setLastObserved(DateTimeUtilities.applyOffsetToDateTimeInSeconds(SGEH_LAST_SEEN_RAW, TEST_TZ_OFFSET_IN_SECONDS) + ".0");
        expected.setLastObservedPTMSI(TEST_PTMSI);

        assertEquals(expected, result);
    }

    private void validateResultsLTE_SucRawEnabled(final SubBIDetailsResult result) throws ParseException {
        ...
        expected.setLastObservedSGSN("MME2");
        expected.setFirstObserved(DateTimeUtilities.applyOffsetToDateTimeInSeconds(LTE_FIRST_SEEN_RAW, TEST_TZ_OFFSET_IN_SECONDS) + ".0");
        expected.setLastObserved(DateTimeUtilities.applyOffsetToDateTimeInSeconds(LTE_LAST_SEEN_RAW, TEST_TZ_OFFSET_IN_SECONDS) + ".0");
        expected.setLastObservedPTMSI("");

        assertEquals(expected, result);
    }

    private void validateResultsPTMSI_SucRawEnabled(final SubBIDetailsResult result) throws ParseException {
        final SubBIDetailsResult expected = new SubBIDetailsResult();
    ...
    private void validateResultsSGEH_SucRawDisabled(final SubBIDetailsResult result) throws ParseException {
        final SubBIDetailsResult expected = new SubBIDetailsResult();
        expected.setVipStatus("1");
        expected.setMsisdn(Long.toString(TEST_MSISDN));
        expected.setHomeCountry("China");
        ...
        expected.setLastObservedSGSN("MME2");
        expected.setFirstObserved(DateTimeUtilities.applyOffsetToDateTimeInSeconds(SGEH_FIRST_SEEN_RAW, TEST_TZ_OFFSET_IN_SECONDS) + ".0");
        expected.setLastObserved(DateTimeUtilities.applyOffsetToDateTimeInSeconds(SGEH_LAST_SEEN_IMSI_RAW, TEST_TZ_OFFSET_IN_SECONDS) + ".0");
        expected.setLastObservedPTMSI(TEST_PTMSI);

        assertEquals(expected, result);
    }

    private void validateResultsSGEH_SucRawDisabled_Invalid_IMSI_Mcc_Mnc(final SubBIDetailsResult result) throws ParseException {
        final SubBIDetailsResult expected = new SubBIDetailsResult();
        expected.setVipStatus("1");
    ...
    private void validateResultsLTE_SucRawDisabled(final SubBIDetailsResult result) throws ParseException {
        ...
        expected.setLastObservedSGSN("MME2");
        expected.setFirstObserved(DateTimeUtilities.applyOffsetToDateTimeInSeconds(LTE_FIRST_SEEN_RAW, TEST_TZ_OFFSET_IN_SECONDS) + ".0");
        expected.setLastObserved(DateTimeUtilities.applyOffsetToDateTimeInSeconds(LTE_LAST_SEEN_IMSI_RAW, TEST_TZ_OFFSET_IN_SECONDS) + ".0");
        expected.setLastObservedPTMSI("");

        assertEquals(expected, result);
    }

    private void validateResultsPTMSI_SucRawDisabled(final SubBIDetailsResult result) throws ParseException {
        final SubBIDetailsResult expected = new SubBIDetailsResult();
        expected.setVipStatus(null);
        expected.setHomeCountry("China");
        expected.setMobileNetworkOperator("China Mobile");
