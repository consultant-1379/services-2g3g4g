...
/**
 * Desrible RoamingDrillByOperatorDataProvider
 * 
 * @author ezhelao
 * @since 02/2012
 */
public class RoamingDrillByOperatorDataProvider {
    public static Object[] provideTestDataForRoamingDrill() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>().add(DISPLAY_PARAM, GRID_PARAM)
                ...
                .add(MAX_ROWS, DEFAULT_MAX_ROWS, NO_MAX_ROWS).add(MCC_PARAM, "310").add(MNC_PARAM, "01").build();
