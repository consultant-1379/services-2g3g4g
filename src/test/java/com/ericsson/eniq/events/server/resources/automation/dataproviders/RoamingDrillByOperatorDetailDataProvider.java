...
/**
 * Desrible RoamingDrillByOperatorDetailDataProvider
 * 
 * @author ezhelao
 * @since 02/2012
 */
public class RoamingDrillByOperatorDetailDataProvider {
    public static Object[] provideTestDataForRoamingDrillDetail() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>().add(DISPLAY_PARAM, GRID_PARAM)
                ...
                .add(MAX_ROWS, DEFAULT_MAX_ROWS, NO_MAX_ROWS).add(EVENT_ID_PARAM, "1").add(MCC_PARAM, "310").add(MNC_PARAM, "01").build();
