...
public class QOSSStatisticsTestDataProvider {

    private static final String TEST_TAC_EVENT_ID = "2,3,28";
    ...
    private static final String TEST_TAC_NODE = "LITEON i5,91121930";
    ...
    public static Object[] provideTestDataForTAC() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>().add(DISPLAY_PARAM, GRID_PARAM)
                .add(TYPE_PARAM, TYPE_TAC).add(TIME_QUERY_PARAM, THIRTY_MINUTES, ONE_DAY, ONE_WEEK).add(NODE_PARAM, TEST_TAC_NODE)
                .add(TZ_OFFSET, TEST_VALUE_TIMEZONE_OFFSET).add(MAX_ROWS, DEFAULT_MAX_ROWS, NO_MAX_ROWS).build();
        return convertToArrayOfMultivaluedMap(combinationGenerator.getAllCombinations());
    }
    ...
    public static Object[] provideTestDataForTACGroup() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>().add(DISPLAY_PARAM, GRID_PARAM)
                .add(TYPE_PARAM, TYPE_TAC).add(GROUP_NAME_PARAM, TEST_TAC_GROUP_NAME, EXCLUSIVE_TAC_GROUP_NAME)
    ...
    public static Object[] provideTestDataForCell() {
        final CombinationGenerator<String> combinationGenerator = new CombinationGeneratorImpl.Builder<String>().add(DISPLAY_PARAM, GRID_PARAM)
                .add(TIME_QUERY_PARAM, THIRTY_MINUTES, ONE_DAY, ONE_WEEK).add(NODE_PARAM, TEST_CELL_NODE).add(TYPE_PARAM, TYPE_CELL)
                .add(TZ_OFFSET, TEST_VALUE_TIMEZONE_OFFSET).add(MAX_ROWS, DEFAULT_MAX_ROWS, NO_MAX_ROWS).build();
        return convertToArrayOfMultivaluedMap(combinationGenerator.getAllCombinations());
    }
