...
public class CauseCodeAnalysisResourceGroupSummaryRawTest extends TestsWithTemporaryTablesBaseTestCase<CauseCodeAnalysisSummaryResult> {
    ...
    //See base class for where this is added to EXCLUSIVE_TAC group
    private static final int SAMPLE_EXCLUSIVE_TAC = 102500;

    private static final int IMSI_3 = 1111155;

    private static final String APN_1 = "blackberry.net";

    private static final String GROUP_TYPE_E_APN = "#GROUP_TYPE_E_APN";

    private final static HashMap<String, String> apnGroupTableColumns = new HashMap<String, String>();

    private final static HashMap<String, Object> valuesForGroupTable = new HashMap<String, Object>();
    ...
    static {
        ...
        causeCodeHelpMapping.put(causeCode_7, "help causeCode_7");
        causeCodeHelpMapping.put(causeCode_38, "help causeCode_38");
        causeCodeHelpMapping.put(causeCode_17, "help causeCode_17");
        causeCodeHelpMapping.put(causeCode_29, "help causeCode_29");
        ...
        causeCodeHelpMappingLTE.put(causeCode_38, "cc lte help causeCode_38");
    ...
    private void validateResult(final String json) throws Exception {
        ...
        assertThat(firstResult.getCauseCodeHelp(), is(causeCodeHelpMapping.get(causeCode_17)));
        ...
        assertThat(secondResult.getCauseCodeHelp(), is(causeCodeHelpMapping.get(causeCode_29)));
        ...
        assertThat(thirdResult.getCauseCodeHelp(), is(causeCodeHelpMappingLTE.get(causeCode_38)));
        ...
        assertThat(fourthResult.getCauseCodeHelp(), is(causeCodeHelpMapping.get(causeCode_38)));
        ...
        assertThat(fifthResult.getCauseCodeHelp(), is(causeCodeHelpMappingLTE.get(causeCode_38)));
        ...
        assertThat(sixthResult.getCauseCodeHelp(), is(causeCodeHelpMappingLTE.get(causeCode_38)));
    ...
    private void populateTemporaryTables() throws SQLException {
        ...
        try {
            ...
            insertRow(TEMP_EVENT_E_LTE_ERR_RAW, causeCode_38, subCauseCode_56, IMSI_3, SAMPLE_EXCLUSIVE_TAC, APN_1, sqlExecutor, dateTime);
            insertRow(TEMP_EVENT_E_LTE_ERR_RAW, causeCode_38, subCauseCode_56, IMSI_3, SAMPLE_EXCLUSIVE_TAC, APN_1, sqlExecutor, dateTime);
