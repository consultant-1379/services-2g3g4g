...
import com.ericsson.eniq.events.server.test.queryresults.KPIByTypeSGSNDrillTypeBscResult;
import com.ericsson.eniq.events.server.test.schema.Nullable;
import com.ericsson.eniq.events.server.test.stubs.DummyUriInfoImpl;
import com.ericsson.eniq.events.server.test.util.DateTimeUtilities;
import com.sun.jersey.core.util.MultivaluedMapImpl;

public class KPIRatioTypeSGSNDrillTypeBscTest extends TestsWithTemporaryTablesBaseTestCase<KPIByTypeSGSNDrillTypeBscResult> {
    ...
    @Test
    public void testTypeSGSNDrilltypeBSC_2G3GEventId() throws Exception {
        ...
        createAndPopulateRawTablesForSgehQuery(timestamp, 12, 2, localDateId);
        final String result = runQuery(SAMPLE_SGSN, ISRAU_IN_2G_AND_3G, TWO_WEEKS, ERICSSON, SAMPLE_BSC, Integer.toString(RAT_FOR_GSM),TIME_ZONE_OFFSET_OF_PLUS_ONE_HOUR);
    ...
    public void testTypeSGSNDrilltypeSGSN_2G3GEventIdWithDataTiering() throws Exception {
        ...
        final String localDateId = dateOnlyFormatter.format(dateOnlyFormatter.parse(timestamp));
        createAndPopulateRawTablesForSgehQuery(timestamp, 1, 1, localDateId);
        final String json = runQuery(SAMPLE_SGSN, ISRAU_IN_2G_AND_3G, THIRTY_MINUTES, ERICSSON, SAMPLE_BSC, Integer.toString(RAT_FOR_GSM),TIME_ZONE_OFFSET_OF_PLUS_ONE_HOUR);

        final List<KPIByTypeSGSNDrillTypeBscResult> results = getTranslator().translateResult(json, KPIByTypeSGSNDrillTypeBscResult.class);

        assertThat(results.size(), is(1));
        final KPIByTypeSGSNDrillTypeBscResult result = results.get(0);
    ...
    @Test
    public void testTypeSGSNDrilltypeSGSN_2G3GEventIdWithDataTiering_MinusEightTimeZone() throws Exception {
        jndiProperties.setUpDataTieringJNDIProperty();
        final String timestamp = DateTimeUtilities.getDateTimeMinus25Minutes();
        final String localDateId = dateOnlyFormatter.format(dateOnlyFormatter.parse(timestamp));
        createAndPopulateRawTablesForSgehQuery(timestamp, 1, 1, localDateId);
        final String json = runQuery(SAMPLE_SGSN, ISRAU_IN_2G_AND_3G, THIRTY_MINUTES, ERICSSON, SAMPLE_BSC, Integer.toString(RAT_FOR_GSM),TIME_ZONE_OFFSET_OF_MINUS_EIGHT_HOUR);
    ...
    public void testTypeSGSNDrilltypeSGSN_2G3GEventIdWithDataTiering_6Hours() throws Exception {
        ...
        final String localDateId = dateOnlyFormatter.format(dateOnlyFormatter.parse(timestamp));
        System.out.println(localDateId);
        createAndPopulateRawTablesForSgehQuery(timestamp, 1, 1, localDateId);
        final String json = runQuery(SAMPLE_SGSN, ISRAU_IN_2G_AND_3G, SIX_HOURS, ERICSSON, SAMPLE_BSC, Integer.toString(RAT_FOR_GSM),TIME_ZONE_OFFSET_OF_PLUS_ONE_HOUR);
    ...
    @Test
    public void testTypeSGSNDrilltypeSGSN_2G3GEventIdWithDataTiering_6Hours_MinusEightTimezone() throws Exception {
        jndiProperties.setUpDataTieringJNDIProperty();
        final String timestamp = DateTimeUtilities.getDateTimeMinus55Minutes();
        System.out.println(timestamp);
        final String localDateId = dateOnlyFormatter.format(dateOnlyFormatter.parse(timestamp));
        System.out.println(localDateId);
        createAndPopulateRawTablesForSgehQuery(timestamp, 1, 1, localDateId);
        final String json = runQuery(SAMPLE_SGSN, ISRAU_IN_2G_AND_3G, SIX_HOURS, ERICSSON, SAMPLE_BSC, Integer.toString(RAT_FOR_GSM),TIME_ZONE_OFFSET_OF_MINUS_EIGHT_HOUR);
    ...
    @Test
    public void testTypeSGSNDrilltypeSGSN_2G3GEventIdWithDataTiering_One_Week() throws Exception {
        jndiProperties.setUpDataTieringJNDIProperty();
        final String timestamp = DateTimeUtilities.getDateMinus24Hours();
        final String localDateId = dateOnlyFormatter.format(dateOnlyFormatter.parse(timestamp));
        createAndPopulateRawTablesForSgehQuery(timestamp, 1, 1, localDateId);
        final String json = runQuery(SAMPLE_SGSN, ISRAU_IN_2G_AND_3G, ONE_WEEK, ERICSSON, SAMPLE_BSC, Integer.toString(RAT_FOR_GSM),TIME_ZONE_OFFSET_OF_PLUS_ONE_HOUR);
    ...
    @Test
    public void testTypeSGSNDrilltypeSGSN_2G3GEventIdWithDataTiering_One_Week_PlusFiveThirtyTimezone() throws Exception {
        jndiProperties.setUpDataTieringJNDIProperty();
        final String timestamp = DateTimeUtilities.getDateMinus24Hours();
        final String localDateId = dateOnlyFormatter.format(dateOnlyFormatter.parse(timestamp));
        createAndPopulateRawTablesForSgehQuery(timestamp, 1, 1, localDateId);
        final String json = runQuery(SAMPLE_SGSN, ISRAU_IN_2G_AND_3G, ONE_WEEK, ERICSSON, SAMPLE_BSC, Integer.toString(RAT_FOR_GSM),TIME_ZONE_OFFSET_OF_PLUS_FIVE_THIRTY);
    ...
    @Test
    public void testTypeSGSNDrilltypeSGSN_2G3GEventIdWithDataTiering_One_Week_MinusEightTimezone() throws Exception {
        jndiProperties.setUpDataTieringJNDIProperty();
        final String timestamp = DateTimeUtilities.getDateMinus24Hours();
        final String localDateId = dateOnlyFormatter.format(dateOnlyFormatter.parse(timestamp));
        createAndPopulateRawTablesForSgehQuery(timestamp, 1, 1, localDateId);
        final String json = runQuery(SAMPLE_SGSN, ISRAU_IN_2G_AND_3G, ONE_WEEK, ERICSSON, SAMPLE_BSC, Integer.toString(RAT_FOR_GSM),TIME_ZONE_OFFSET_OF_MINUS_EIGHT_HOUR);
    ...
    public void testTypeSGSNDrilltypeSGSN_4GEventId() throws Exception {
        final String timestamp = DateTimeUtilities.getDateTimeMinus48Hours();
        final String localDateId = dateOnlyFormatter.format(dateOnlyFormatter.parse(timestamp));
        createAndPopulateRawTablesForLteQuery(timestamp, 8, 10, localDateId);
        final String result = runQuery(SAMPLE_MME, TAU_IN_4G, TWO_WEEKS, ERICSSON, SAMPLE_ERBS, Integer.toString(RAT_FOR_LTE),TIME_ZONE_OFFSET_OF_PLUS_ONE_HOUR);
        validateResultForLTEQuery(result);
    }

    @Test
    public void testTypeSGSNDrilltypeSGSN_2G3GEventIdWithDataTiering_6HoursWithImsiAgg() throws Exception {
    ...
    @Test
    public void testTypeSGSNDrilltypeSGSN_2G3GEventIdWithDataTiering_6HoursWithImsiAggWithUnknownToplogy() throws Exception {
        jndiProperties.disableSucRawJNDIProperty();
        createImsiAggregationTables();
        createTopologyTables();
        populateTopologyForSgehQuery();
        ...
        final String json = runQuery(SAMPLE_SGSN, ISRAU_IN_2G_AND_3G, SIX_HOURS, ApplicationConstants.UNKNOWN, ApplicationConstants.UNKNOWN,
                Integer.toString(RAT_FOR_GSM),TIME_ZONE_OFFSET_OF_PLUS_ONE_HOUR);
    ...
    @Test
    public void testTypeSGSNDrilltypeSGSN_4GEventIdWithImsiAgg() throws Exception {
        jndiProperties.disableSucRawJNDIProperty();
        createImsiAggregationTables();
        createTopologyTables();
        populateTopologyForSgehQuery();
        ...
        populateSuccessImsiAggregationTablesForSgehQuery(timestamp);
        createAndPopulateRawTablesForLteQuery(timestamp, 8, 10, localDateId);
        final String result = runQuery(SAMPLE_MME, TAU_IN_4G, ONE_WEEK, ERICSSON, SAMPLE_ERBS, Integer.toString(RAT_FOR_LTE),TIME_ZONE_OFFSET_OF_PLUS_ONE_HOUR);
        validateResultForLTEQuery(result);
    }

    @Test
    public void testTypeSGSNDrilltypeSGSN_4GEventIdWithImsiAggWithUnknownToplogy() throws Exception {
        jndiProperties.disableSucRawJNDIProperty();
        createImsiAggregationTables();
        createTopologyTables();
        populateTopologyForSgehQuery();
        ...
        populateSuccessImsiAggregationTablesForSgehQuery(timestamp);
        createAndPopulateRawTablesForLteQuery(timestamp, 8, 10, localDateId);
        final String result = runQuery(SAMPLE_MME, TAU_IN_4G, ONE_WEEK, ApplicationConstants.UNKNOWN, UNKNOWN_ENODEB_ID,
                Integer.toString(RAT_FOR_LTE),TIME_ZONE_OFFSET_OF_PLUS_ONE_HOUR);
        validateResultForLTEQueryUnknownTopology(result);
    }

    private String runQuery(final String sgsnOrMME, final int eventId, final String time, final String vendor, final String hier3, final String rat,final String Tzoffset)
    ...
    private void createAndPopulateRawTablesForSgehQuery(final String timestamp, final int noOfErrorRowsInRaw, final int noOfSuccessRowsInRaw,
        ...
        final Map<String, Object> columnsAndValuesForRawTable = new HashMap<String, Object>();
        final Map<String, Object> columnsAndValuesForTacTable = new HashMap<String, Object>();
        columnsAndValuesForRawTable.put(APN, SAMPLE_APN);
        ...
        columnsAndValuesForTacTable.put(APN, SAMPLE_APN);
        columnsAndValuesForTacTable.put(EVENT_SOURCE_NAME, SAMPLE_SGSN);
        columnsAndValuesForTacTable.put(VENDOR_PARAM_UPPER_CASE, ERICSSON);
        columnsAndValuesForTacTable.put(IMSI, SAMPLE_IMSI);
        columnsAndValuesForTacTable.put(HIERARCHY_3, SAMPLE_BSC);
        columnsAndValuesForTacTable.put(HIERARCHY_1, SAMPLE_BSC_CELL);
        columnsAndValuesForTacTable.put(EVENT_ID, ISRAU_IN_2G_AND_3G);
        columnsAndValuesForTacTable.put(RAT, RAT_FOR_GSM);
        columnsAndValuesForTacTable.put(TAC, SAMPLE_EXCLUSIVE_TAC);
        columnsAndValuesForTacTable.put(DEACTIVATION_TRIGGER, 1);
        columnsAndValuesForTacTable.put(DATETIME_ID, timestamp);
        columnsAndValuesForTacTable.put(LOCAL_DATE_ID, localDateId);
        ...
        insertRow(TEMP_EVENT_E_SGEH_SUC_RAW, columnsAndValuesForTacTable);
        insertRow(TEMP_EVENT_E_SGEH_ERR_RAW, columnsAndValuesForTacTable);
        insertRow(TEMP_EVENT_E_LTE_ERR_RAW, columnsAndValuesForTacTable);
        insertRow(TEMP_EVENT_E_LTE_SUC_RAW, columnsAndValuesForTacTable);
    }
}
