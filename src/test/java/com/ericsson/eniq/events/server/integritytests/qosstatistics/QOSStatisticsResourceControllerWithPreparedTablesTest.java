 ...
 *
 */
public class QOSStatisticsResourceControllerWithPreparedTablesTest extends
        BaseQOSStatisticsResourceWithPreparedTablesTest {

    public QOSStatisticsResourceControllerWithPreparedTablesTest() {
    ...
    @Test
    public void testGetSummary_OneWeek_Controller() throws Exception {
        final String node = ERBS1 + COMMA + ERICSSON + COMMA + RAT_INTEGER_VALUE_FOR_4G;
        getQCISummaryForTwoWeeks(TYPE_BSC, node);
