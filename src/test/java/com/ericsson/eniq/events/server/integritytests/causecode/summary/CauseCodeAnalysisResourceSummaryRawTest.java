...
public class CauseCodeAnalysisResourceSummaryRawTest extends TestsWithTemporaryTablesBaseTestCase<CauseCodeAnalysisSummaryResult> {
    ...
    private final static int causeCode_35 = 35;
    ...
    private final static int subCauseCode_0 = 0;
    ...
    static {
        ...
        causeCodeHelpMapping.put(causeCode_7, "causeCode_7 help");
        causeCodeHelpMapping.put(causeCode_38, "causeCode_38 help");
        causeCodeHelpMapping.put(causeCode_17, "causeCode_17 help ");
        causeCodeHelpMapping.put(causeCode_29, EMPTY_STRING);
        ...
        causeCodeHelpMappingLTE.put(causeCode_38, "causeCode_38 lte help");

        causeCodeMappingLTE.put(causeCode_35, "Requested service option authorized in this PLMN PTI already in use");

        causeCodeHelpMappingLTE.put(causeCode_35, "causeCode_35 lte help");
        ...
        subCauseCodeHelpMapping.put(subCauseCode_12, EMPTY_STRING);
        subCauseCodeHelpMapping.put(subCauseCode_56, EMPTY_STRING);
    ...
    public void testGetSummaryData_CauseCode_APN() throws Exception {
        ...
        populateTemporaryTables(DateTimeUtilities.getDateTime(Calendar.MINUTE, -20));
        ...
        makeAssertions(summaryResult, APN_1);

    }

    @Test
    public void testGetSummaryData_CauseCode_APN_WEEK() throws Exception {

        createAggTemporaryTableAPN(TEMP_EVENT_E_LTE_APN_CC_SCC_ERR_DAY);
        createAggTemporaryTableAPN(TEMP_EVENT_E_SGEH_APN_CC_SCC_ERR_DAY);
        createAggTemporaryTable(TEMP_EVENT_E_SGEH_EVNTSRC_CC_SCC_ERR_DAY);
        createAggTemporaryTable(TEMP_EVENT_E_LTE_EVNTSRC_CC_SCC_ERR_DAY);
        populateTemporaryTables(DateTimeUtilities.getDateTimeMinusDay(3));
        populateTemporaryAggTables(DateTimeUtilities.getDateTimeMinusDay(3));
        populateTemporaryAggTablesAPN(DateTimeUtilities.getDateTimeMinusDay(3));
        ...
        makeAssertionsAPN(summaryResult);

    }

    @Test
    public void testGetSummaryData_CauseCode_SGSN_oneWeek() throws Exception {

        final String dateTime = DateTimeUtilities.getDateMinus48Hours();

        createAggTemporaryTable(TEMP_EVENT_E_SGEH_EVNTSRC_CC_SCC_ERR_DAY);
        createAggTemporaryTable(TEMP_EVENT_E_LTE_EVNTSRC_CC_SCC_ERR_DAY);
        populateTemporaryAggTables(dateTime);
        ...
        makeAssertions_Sgsn(summaryResult);
    ...
    public void testGetSummaryData_CauseCode_SGSN() throws Exception {
        ...
        makeAssertions(summaryResult, SAMPLE_SGSN);

    }

    private void makeAssertions(final List<CauseCodeAnalysisSummaryResult> summaryResult, final String nodeType) {
        assertThat(summaryResult.size(), is(6));

        final CauseCodeAnalysisSummaryResult firstResult = summaryResult.get(0);
        assertThat(firstResult.getNode(), is(nodeType));
        ...
        assertThat(firstResult.getSubCauseCodeHelp(), is(EMPTY_STRING));
        ...
        assertThat(secondResult.getNode(), is(nodeType));
        ...
        final CauseCodeAnalysisSummaryResult fourthResult = summaryResult.get(3);
        assertThat(fourthResult.getNode(), is(nodeType));
        ...
        final CauseCodeAnalysisSummaryResult thirdResult = summaryResult.get(4);
        assertThat(thirdResult.getNode(), is(nodeType));
        ...
        final CauseCodeAnalysisSummaryResult fifthResult = summaryResult.get(5);
        assertThat(fifthResult.getNode(), is(nodeType));
        ...
        assertThat(fifthResult.getSubCauseCodeID(), is(Integer.toString(subCauseCode_522)));
        assertThat(fifthResult.getSubCauseCode(), is(subCauseCodeMappingLTE.get(subCauseCode_522)));
        // as DIM_E_LTE_CC_SCC table doesnt exist yet query will return "" as
        // advice for all LTE
        assertThat(fifthResult.getSubCauseCodeHelp(), is(subCauseCodeHelpMappingLTE.get(subCauseCode_522)));
        assertThat(fifthResult.getOccurrences(), is("2"));
        assertThat(fifthResult.getImpactedSubscribers(), is("1"));

        final CauseCodeAnalysisSummaryResult sixthResult = summaryResult.get(2);
        assertThat(sixthResult.getNode(), is(nodeType));
        ...
        assertThat(sixthResult.getCauseCodeID(), is(Integer.toString(causeCode_35)));
        assertThat(sixthResult.getCauseCode(), is(causeCodeMappingLTE.get(causeCode_35)));
        assertThat(sixthResult.getSubCauseCodeID(), is(Integer.toString(subCauseCode_0)));
        assertThat(sixthResult.getSubCauseCode(), is(subCauseCodeMappingLTE.get(subCauseCode_0)));
        assertThat(sixthResult.getSubCauseCodeHelp(), is(subCauseCodeHelpMappingLTE.get(subCauseCode_0)));
        assertThat(sixthResult.getOccurrences(), is("2"));
        assertThat(sixthResult.getImpactedSubscribers(), is("1"));

    }

    private void makeAssertionsAPN(final List<CauseCodeAnalysisSummaryResult> summaryResult) {
        assertThat(summaryResult.size(), is(5));

        final CauseCodeAnalysisSummaryResult firstResult = summaryResult.get(0);
        assertThat(firstResult.getNode(), is(APN_1));
        assertThat(firstResult.getCauseProtocolType(), is(Integer.toString(causeProtTypeUsedInTable)));
        assertThat(firstResult.getCauseProtocolTypeDescription(), is(DESC_FOR_CAUSE_PROT_TYPE_1_IN_2G));
        assertThat(firstResult.getCauseCodeID(), is(Integer.toString(causeCode_17)));
        assertThat(firstResult.getCauseCode(), is(causeCodeMapping.get(causeCode_17)));
        ...
        assertThat(firstResult.getSubCauseCode(), is(subCauseCodeMapping.get(subCauseCode_12)));
        assertThat(firstResult.getSubCauseCodeHelp(), is(EMPTY_STRING));
        assertThat(firstResult.getOccurrences(), is("12"));
        assertThat(firstResult.getImpactedSubscribers(), is("1"));

        final CauseCodeAnalysisSummaryResult secondResult = summaryResult.get(1);
        assertThat(secondResult.getNode(), is(APN_1));
        assertThat(secondResult.getCauseProtocolType(), is(Integer.toString(causeProtTypeUsedInTable)));
        assertThat(secondResult.getCauseProtocolTypeDescription(), is(DESC_FOR_CAUSE_PROT_TYPE_1_IN_2G));
        assertThat(secondResult.getCauseCodeID(), is(Integer.toString(causeCode_29)));
        assertThat(secondResult.getCauseCode(), is(causeCodeMapping.get(causeCode_29)));
        ...
        final CauseCodeAnalysisSummaryResult thirdResult = summaryResult.get(2);
        assertThat(thirdResult.getNode(), is(APN_1));
        assertThat(thirdResult.getCauseProtocolType(), is(Integer.toString(causeProtTypeUsedInTable)));
        ...
        final CauseCodeAnalysisSummaryResult fourthResult = summaryResult.get(3);
        assertThat(fourthResult.getNode(), is(APN_1));
        assertThat(fourthResult.getCauseProtocolType(), is(Integer.toString(causeProtTypeUsedInTable)));
        ...
        assertThat(fourthResult.getSubCauseCodeHelp(), is(subCauseCodeHelpMapping.get(subCauseCode_56)));
        assertThat(fourthResult.getOccurrences(), is("16"));
        assertThat(fourthResult.getImpactedSubscribers(), is("1"));

        final CauseCodeAnalysisSummaryResult fifthResult = summaryResult.get(4);
        assertThat(fifthResult.getNode(), is(APN_1));
        assertThat(fifthResult.getCauseProtocolType(), is(Integer.toString(causeProtTypeUsedInTable)));
        assertThat(fifthResult.getCauseProtocolTypeDescription(), is(DESC_FOR_CAUSE_PROT_TYPE_1_IN_4G));
        assertThat(fifthResult.getCauseCodeID(), is(Integer.toString(causeCode_38)));
        assertThat(fifthResult.getCauseCode(), is(causeCodeMappingLTE.get(causeCode_38)));
        ...
        // advice for all LTE
        assertThat(fifthResult.getSubCauseCodeHelp(), is(subCauseCodeHelpMappingLTE.get(subCauseCode_522)));
        assertThat(fifthResult.getOccurrences(), is("8"));
        assertThat(fifthResult.getImpactedSubscribers(), is("1"));

    }

    private void makeAssertions_Sgsn(final List<CauseCodeAnalysisSummaryResult> summaryResult) {
        assertThat(summaryResult.size(), is(4));

        final CauseCodeAnalysisSummaryResult firstResult = summaryResult.get(0);
        assertThat(firstResult.getNode(), is(SAMPLE_SGSN));
        assertThat(firstResult.getCauseProtocolType(), is(Integer.toString(causeProtTypeUsedInTable)));
        assertThat(firstResult.getCauseProtocolTypeDescription(), is(DESC_FOR_CAUSE_PROT_TYPE_1_IN_4G));
        assertThat(firstResult.getCauseCodeID(), is(Integer.toString(causeCode_17)));
        assertThat(firstResult.getCauseCode(), is(EMPTY_STRING));
        assertThat(firstResult.getSubCauseCodeID(), is(Integer.toString(subCauseCode_12)));
        assertThat(firstResult.getSubCauseCode(), is(subCauseCodeMappingLTE.get(subCauseCode_12)));
        assertThat(firstResult.getSubCauseCodeHelp(), is(EMPTY_STRING));
        assertThat(firstResult.getOccurrences(), is("8"));
        assertThat(firstResult.getImpactedSubscribers(), is(EMPTY_STRING));

        final CauseCodeAnalysisSummaryResult secondResult = summaryResult.get(1);
        assertThat(secondResult.getNode(), is(SAMPLE_SGSN));
        assertThat(secondResult.getCauseProtocolType(), is(Integer.toString(causeProtTypeUsedInTable)));
        assertThat(secondResult.getCauseProtocolTypeDescription(), is(DESC_FOR_CAUSE_PROT_TYPE_1_IN_2G));
        assertThat(secondResult.getCauseCodeID(), is(Integer.toString(causeCode_17)));
        assertThat(secondResult.getCauseCode(), is(causeCodeMapping.get(causeCode_17)));
        assertThat(secondResult.getSubCauseCodeID(), is(Integer.toString(subCauseCode_12)));
        assertThat(secondResult.getSubCauseCode(), is(subCauseCodeMapping.get(subCauseCode_12)));
        assertThat(secondResult.getSubCauseCodeHelp(), is(EMPTY_STRING));
        assertThat(secondResult.getOccurrences(), is("8"));
        assertThat(secondResult.getImpactedSubscribers(), is("1"));

        final CauseCodeAnalysisSummaryResult thirdResult = summaryResult.get(2);
        assertThat(thirdResult.getNode(), is(SAMPLE_SGSN));
        assertThat(thirdResult.getCauseProtocolType(), is(Integer.toString(causeProtTypeUsedInTable)));
        assertThat(thirdResult.getCauseProtocolTypeDescription(), is(DESC_FOR_CAUSE_PROT_TYPE_1_IN_2G));
        assertThat(thirdResult.getCauseCodeID(), is(Integer.toString(causeCode_38)));
        assertThat(thirdResult.getCauseCode(), is(causeCodeMapping.get(causeCode_38)));
        ...
        final CauseCodeAnalysisSummaryResult fourthResult = summaryResult.get(3);
        assertThat(fourthResult.getNode(), is(SAMPLE_SGSN));
        assertThat(fourthResult.getCauseProtocolType(), is(Integer.toString(causeProtTypeUsedInTable)));
        assertThat(fourthResult.getCauseProtocolTypeDescription(), is(DESC_FOR_CAUSE_PROT_TYPE_1_IN_4G));
        assertThat(fourthResult.getCauseCodeID(), is(Integer.toString(causeCode_38)));
        assertThat(fourthResult.getCauseCode(), is(causeCodeMappingLTE.get(causeCode_38)));
        assertThat(fourthResult.getSubCauseCodeID(), is(Integer.toString(subCauseCode_56)));
        assertThat(fourthResult.getSubCauseCode(), is(EMPTY_STRING));
        assertThat(fourthResult.getSubCauseCodeHelp(), is(subCauseCodeHelpMapping.get(subCauseCode_56)));
        assertThat(fourthResult.getOccurrences(), is("8"));
        assertThat(fourthResult.getImpactedSubscribers(), is(EMPTY_STRING));
    }

    private void populateTemporaryTables(String dateTime) throws SQLException {
        SQLExecutor sqlExecutor = null;
        try {
            sqlExecutor = new SQLExecutor(connection);

            insertRow(TEMP_EVENT_E_SGEH_ERR_RAW, causeCode_17, subCauseCode_12, IMSI_1, TAC_1, APN_1, sqlExecutor, dateTime, SAMPLE_SGSN, dateTime);
            insertRow(TEMP_EVENT_E_SGEH_ERR_RAW, causeCode_38, subCauseCode_56, IMSI_1, TAC_1, APN_1, sqlExecutor, dateTime, SAMPLE_SGSN, dateTime);
            insertRow(TEMP_EVENT_E_SGEH_ERR_RAW, causeCode_17, subCauseCode_12, IMSI_1, TAC_1, APN_1, sqlExecutor, dateTime, SAMPLE_SGSN, dateTime);
            insertRow(TEMP_EVENT_E_SGEH_ERR_RAW, causeCode_17, subCauseCode_12, IMSI_1, TAC_1, APN_1, sqlExecutor, dateTime, SAMPLE_SGSN, dateTime);

            insertRow(TEMP_EVENT_E_SGEH_ERR_RAW, causeCode_29, subCauseCode_42, IMSI_1, TAC_1, APN_1, sqlExecutor, dateTime, SAMPLE_SGSN, dateTime);
            insertRow(TEMP_EVENT_E_SGEH_ERR_RAW, causeCode_29, subCauseCode_42, IMSI_1, TAC_1, APN_1, sqlExecutor, dateTime, SAMPLE_SGSN, dateTime);

            insertRow(TEMP_EVENT_E_LTE_ERR_RAW, causeCode_38, subCauseCode_522, IMSI_2, TAC_1, APN_1, sqlExecutor, dateTime, SAMPLE_SGSN, dateTime);
            insertRow(TEMP_EVENT_E_LTE_ERR_RAW, causeCode_38, subCauseCode_522, IMSI_2, TAC_1, APN_1, sqlExecutor, dateTime, SAMPLE_SGSN, dateTime);

            insertRow(TEMP_EVENT_E_LTE_ERR_RAW, causeCode_38, subCauseCode_12, IMSI_2, TAC_1, APN_1, sqlExecutor, dateTime, SAMPLE_SGSN, dateTime);
            insertRow(TEMP_EVENT_E_LTE_ERR_RAW, causeCode_38, subCauseCode_12, IMSI_2, TAC_1, APN_1, sqlExecutor, dateTime, SAMPLE_SGSN, dateTime);
            insertRow(TEMP_EVENT_E_LTE_ERR_RAW, causeCode_35, subCauseCode_0, IMSI_2, TAC_1, APN_1, sqlExecutor, dateTime, SAMPLE_SGSN, dateTime);
            insertRow(TEMP_EVENT_E_LTE_ERR_RAW, causeCode_35, subCauseCode_0, IMSI_2, TAC_1, APN_1, sqlExecutor, dateTime, SAMPLE_SGSN, dateTime);
    ...
    private void insertRow(final String table, final int causeCode, final int subCauseCode, final int testImsi, final int testTac,
                           final String testNode, final SQLExecutor sqlExecutor, final String dateTime, final String sgsnName, final String date)
            throws SQLException {
        sqlExecutor.executeUpdate("insert into " + table + " values(" + causeCode + "," + subCauseCode + "," + causeProtTypeUsedInTable + ","
                + testImsi + "," + testTac + ",'" + testNode + "','" + dateTime + "','" + sgsnName + "','" + date + "')");
    }

    private void populateTemporaryAggTables(String dateTime) throws SQLException {
        SQLExecutor sqlExecutor = null;
        try {
            sqlExecutor = new SQLExecutor(connection);
            insertRowAgg(sqlExecutor, TEMP_EVENT_E_LTE_EVNTSRC_CC_SCC_ERR_DAY, 4, dateTime, SAMPLE_SGSN, causeProtTypeUsedInTable, causeCode_17,
                    subCauseCode_12);
            insertRowAgg(sqlExecutor, TEMP_EVENT_E_SGEH_EVNTSRC_CC_SCC_ERR_DAY, 4, dateTime, SAMPLE_SGSN, causeProtTypeUsedInTable, causeCode_17,
                    subCauseCode_12);
            insertRowAgg(sqlExecutor, TEMP_EVENT_E_LTE_EVNTSRC_CC_SCC_ERR_DAY, 4, dateTime, SAMPLE_SGSN, causeProtTypeUsedInTable, causeCode_17,
                    subCauseCode_12);
            insertRowAgg(sqlExecutor, TEMP_EVENT_E_SGEH_EVNTSRC_CC_SCC_ERR_DAY, 4, dateTime, SAMPLE_SGSN, causeProtTypeUsedInTable, causeCode_17,
            ...
            insertRowAgg(sqlExecutor, TEMP_EVENT_E_LTE_EVNTSRC_CC_SCC_ERR_DAY, 4, dateTime, SAMPLE_SGSN, causeProtTypeUsedInTable, causeCode_38,
                    subCauseCode_56);
            insertRowAgg(sqlExecutor, TEMP_EVENT_E_SGEH_EVNTSRC_CC_SCC_ERR_DAY, 4, dateTime, SAMPLE_SGSN, causeProtTypeUsedInTable, causeCode_38,
                    subCauseCode_56);
            insertRowAgg(sqlExecutor, TEMP_EVENT_E_LTE_EVNTSRC_CC_SCC_ERR_DAY, 4, dateTime, SAMPLE_SGSN, causeProtTypeUsedInTable, causeCode_38,
                    subCauseCode_56);
            insertRowAgg(sqlExecutor, TEMP_EVENT_E_SGEH_EVNTSRC_CC_SCC_ERR_DAY, 4, dateTime, SAMPLE_SGSN, causeProtTypeUsedInTable, causeCode_38,
    ...
    private void populateTemporaryAggTablesAPN(String dateTime) throws SQLException {
        SQLExecutor sqlExecutor = null;
        try {
            sqlExecutor = new SQLExecutor(connection);
            insertRowAgg1(sqlExecutor, TEMP_EVENT_E_LTE_APN_CC_SCC_ERR_DAY, causeCode_38, subCauseCode_522, APN_1, dateTime, 4);
            insertRowAgg1(sqlExecutor, TEMP_EVENT_E_SGEH_APN_CC_SCC_ERR_DAY, causeCode_17, subCauseCode_12, APN_1, dateTime, 4);
            insertRowAgg1(sqlExecutor, TEMP_EVENT_E_LTE_APN_CC_SCC_ERR_DAY, causeCode_38, subCauseCode_522, APN_1, dateTime, 4);
            insertRowAgg1(sqlExecutor, TEMP_EVENT_E_SGEH_APN_CC_SCC_ERR_DAY, causeCode_38, subCauseCode_56, APN_1, dateTime, 4);

            insertRowAgg1(sqlExecutor, TEMP_EVENT_E_LTE_APN_CC_SCC_ERR_DAY, causeCode_38, subCauseCode_12, APN_1, dateTime, 4);
            insertRowAgg1(sqlExecutor, TEMP_EVENT_E_SGEH_APN_CC_SCC_ERR_DAY, causeCode_17, subCauseCode_12, APN_1, dateTime, 4);
            insertRowAgg1(sqlExecutor, TEMP_EVENT_E_LTE_APN_CC_SCC_ERR_DAY, causeCode_38, subCauseCode_12, APN_1, dateTime, 4);
            insertRowAgg1(sqlExecutor, TEMP_EVENT_E_SGEH_APN_CC_SCC_ERR_DAY, causeCode_17, subCauseCode_12, APN_1, dateTime, 4);
            insertRowAgg1(sqlExecutor, TEMP_EVENT_E_LTE_APN_CC_SCC_ERR_DAY, causeCode_38, subCauseCode_12, APN_1, dateTime, 4);
            insertRowAgg1(sqlExecutor, TEMP_EVENT_E_LTE_APN_CC_SCC_ERR_DAY, causeCode_38, subCauseCode_12, APN_1, dateTime, 4);
            insertRowAgg1(sqlExecutor, TEMP_EVENT_E_SGEH_APN_CC_SCC_ERR_DAY, causeCode_29, subCauseCode_42, APN_1, dateTime, 4);
            insertRowAgg1(sqlExecutor, TEMP_EVENT_E_SGEH_APN_CC_SCC_ERR_DAY, causeCode_29, subCauseCode_42, APN_1, dateTime, 4);
        } finally {
            closeSQLExector(sqlExecutor);
        }
    ...
    private void insertRowAgg(final SQLExecutor sqlExecutor, final String table, final int noOfErrors, final String dateTime, final String sgsnName,
                              final int causeProtType, final int causeCode, final int subCauseCode) throws SQLException {
        sqlExecutor.executeUpdate("insert into " + table + " values(" + noOfErrors + ",'" + dateTime + "','" + sgsnName + "'," + causeProtType + ","
                + causeCode + "," + subCauseCode + ")");
    }

    private void insertRowAgg1(final SQLExecutor sqlExecutor, final String table, final int causeCode, final int subCauseCode, final String apnName,
                               final String dateTime, final int noOfErrors) throws SQLException {
        sqlExecutor.executeUpdate("insert into " + table + " values(" + noOfErrors + "," + causeCode + ",'" + subCauseCode + "','"
                + causeProtTypeUsedInTable + "','" + apnName + "','" + dateTime + "')");
    }
    ...
    private void createTemporaryTable(final String tempTableName) throws SQLException {
        ...
        try {
            ...
            sqlExecutor.executeUpdate("create local temporary table " + tempTableName
                    ...
                    + "DATETIME_ID timestamp, EVENT_SOURCE_NAME varchar(128), LOCAL_DATE_ID date)");
    ...
    private void createAggTemporaryTable(String tableName) throws SQLException {
        SQLExecutor sqlExecutor = null;
        try {
            sqlExecutor = new SQLExecutor(connection);
            sqlExecutor.executeUpdate("create local temporary table " + tableName
                    + "(NO_OF_ERRORS smallint, DATETIME_ID timestamp, EVENT_SOURCE_NAME varchar(128),"
                    + " CAUSE_PROT_TYPE tinyint, CAUSE_CODE tinyint,  SUBCAUSE_CODE tinyint)");
    ...
    private void createAggTemporaryTableAPN(String tableName) throws SQLException {
        SQLExecutor sqlExecutor = null;
        try {
            sqlExecutor = new SQLExecutor(connection);
            sqlExecutor
                    .executeUpdate("create local temporary table "
                            + tableName
                            + "(NO_OF_ERRORS smallint, CAUSE_CODE smallint, SUBCAUSE_CODE smallint, CAUSE_PROT_TYPE tinyint, APN varchar(128), DATETIME_ID timestamp)");
