 ...
 * 
 */
public class EventAnalysisDetailedWithPreparedTablesTACTest extends BaseDataIntegrityTest<EventAnalysisDetailedResult> {
    ...
    public void onSetUp() throws Exception {
        ...
        setupRawTableValues(timestamp, localDateId, SAMPLE_TAC, ATTACH_IN_2G_AND_3G, RAT_FOR_GSM, 0,TEST_CAUSE_VALUE_KNOWN,TEST_CAUSE_VALUE_KNOWN,TEST_CAUSE_VALUE_KNOWN);
        ...
        setupRawTableValues(timestamp, localDateId, SAMPLE_TAC, ATTACH_IN_2G_AND_3G, RAT_FOR_GSM, 0,TEST_CAUSE_VALUE_UNKNOWN,TEST_CAUSE_VALUE_UNKNOWN,TEST_CAUSE_VALUE_UNKNOWN);
        valuesForSgehTable.putAll(columnsInRawTables);
        insertRow(TEMP_EVENT_E_SGEH_ERR_RAW, valuesForSgehTable);

        setupRawTableValues(timestamp, localDateId, SAMPLE_TAC, ATTACH_IN_4G, RAT_FOR_LTE, 0,TEST_CAUSE_VALUE_KNOWN,TEST_CAUSE_VALUE_KNOWN,TEST_CAUSE_VALUE_KNOWN);
        ...
        setupRawTableValues(timestamp, localDateId, SAMPLE_TAC, ATTACH_IN_4G, RAT_FOR_LTE, 1,TEST_CAUSE_VALUE_KNOWN,TEST_CAUSE_VALUE_KNOWN,TEST_CAUSE_VALUE_KNOWN);
    ...
    @Test
    public void testGetDetailedData_TAC_1Week_For_ATTACH_IN_2G_AND_3G() throws Exception {

        final MultivaluedMap<String, String> map = new MultivaluedMapImpl();
        map.putSingle(TIME_QUERY_PARAM, ONE_WEEK);
        map.putSingle(TYPE_PARAM, TYPE_TAC);
        map.putSingle(TAC_PARAM, Integer.toString(SAMPLE_TAC));
    ...
    @Test
    public void testGetDetailedData_TAC_1Week_For_ATTACH_IN_4G() throws Exception {
